...
public record CurrentUserResponse(UUID publicId, String email, String displayName, UserRole role) {

    public static CurrentUserResponse from(UserPrincipal principal) {
        return new CurrentUserResponse(
                principal.publicId(), principal.email(), principal.displayName(), principal.role());
    }
}
