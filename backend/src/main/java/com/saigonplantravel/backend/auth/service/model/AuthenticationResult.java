...
public record AuthenticationResult(UUID publicId, String email, String displayName, UserRole role) {

    public static AuthenticationResult from(UserAccount userAccount) {
        return new AuthenticationResult(
                userAccount.getPublicId(), userAccount.getEmail(), userAccount.getDisplayName(), userAccount.getRole());
    }
}
