...
@TestPropertySource(properties =
        "app.security.cors.allowed-origin=http://localhost:3000"
)
class SecurityConfigCorsTest {
    ...
    @Test
    void allowsConfiguredFrontendPreflightWithoutAuthentication()
            throws Exception {
        mockMvc.perform(
    ...
    @Test
    void rejectsPreflightFromUnconfiguredOrigin()
            throws Exception {
        mockMvc.perform(
                        options("/api/v1/places")
                                .header(
