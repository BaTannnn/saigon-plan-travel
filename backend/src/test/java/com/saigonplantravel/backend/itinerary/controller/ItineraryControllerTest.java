...
class ItineraryControllerTest {
    ...
    private static final String PLACE_SLUG =
            "cho-ben-thanh";

    private static final String PLACE_NAME =
            "Chợ Bến Thành";

    private static final BigDecimal PLACE_LATITUDE =
            new BigDecimal("10.7726400");

    private static final BigDecimal PLACE_LONGITUDE =
    ...
    void getsEmptyItineraryUsingAuthenticatedUserId()
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        status().isOk())
                .andExpect(
                        jsonPath("$.tripPublicId")
                                .value(
                                        tripPublicId.toString()))
                .andExpect(
                        jsonPath("$.items")
                                .isEmpty())
                .andExpect(
    ...
    @Test
    void addsPlaceAndReturnsUpdatedCalculatedItinerary()
            throws Exception {
        ...
        mockMvc.perform(
                 ...
                 */
                .andExpect(
                        jsonPath("$.items[0].place.slug")
                                .value(
                                        PLACE_SLUG))
                .andExpect(
                        jsonPath("$.items[0].place.name")
                                .value(
                                        PLACE_NAME))
                .andExpect(
                        jsonPath("$.items[0].place.latitude")
                                .value(
                                        PLACE_LATITUDE.doubleValue()))
                .andExpect(
                        jsonPath("$.items[0].place.longitude")
                                .value(
                                        PLACE_LONGITUDE.doubleValue()))
                ...
                .andExpect(
                        jsonPath(
                                "$.items[0].schedule.arrivalTime")
                                .value(
                                        "08:10:00"))
                .andExpect(
                        jsonPath(
                                "$.items[0].schedule.visitStartTime")
                                .value(
                                        "08:10:00"))
                .andExpect(
                        jsonPath(
                                "$.items[0].schedule.visitEndTime")
                                .value(
                                        "09:40:00"))
                .andExpect(
                        jsonPath(
                                "$.items[0].schedule.travelMinutes")
                                .value(10))
                .andExpect(
                        jsonPath(
                                "$.items[0].schedule.travelDistanceKm")
                                .value(1.5))
                .andExpect(
                        jsonPath(
                                "$.items[0].schedule.estimatedCost")
                                .value(30000))
    ...
    @Test
    void deletesItemUsingTripAndItemPublicIds()
            throws Exception {
    ...
    void mapsDuplicateAndForeignItemFailuresToSafeStatuses()
        ...
        when(itineraryService.addItem(
                ...
                42L))
                .thenThrow(
                        new DuplicateItineraryPlaceException());
    ...
    private ItineraryDetailResponse itineraryResponse(
            UUID tripPublicId) {
        ...
        ItineraryDetailItemResponse item =
                new ItineraryDetailItemResponse(
                        UUID.randomUUID(),
                        1,
                        place,
                        schedule);
    ...
    private ItineraryDetailResponse emptyItineraryResponse(
            UUID tripPublicId) {
